...
<head>
  ...
  <title>Création de votre compte ROBOT- REPPORT</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <p>Votre compte Robot Rapport a ete créer </p>
    <p>Si vous avez des questions ou besoin d'assistance, n'hésitez pas à nous contacter.</p>
    <p>À bientôt !</p>
    <p>Cordialement,<br>Support QC</p>
    <div class="footer">
      <p>Vous recevez cet email car vous vous êtes inscrit sur robot-repport.com .</p>
    </div>
  </div>
</body>
</html>
